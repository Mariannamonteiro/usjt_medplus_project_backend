...
app.post('/envio-de-email', (req, res) => {
    ...
    if(consulta.usuarioLogado === false){
        ...
        transporter.sendMail({
            ...
            <br>
            Para efetivar se cadastro na MEDPLUS, atualize a senha padrão que criamos nesse link:<a href="http://localhost:4200/esquecisenha"> Redefina sua senha MEDPLUS</a>.
            <br>
